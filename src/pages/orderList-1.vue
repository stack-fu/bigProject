          ...
          <div class="order" v-for="(item, index) in list" :key="index">
            ...
            <div class="order-content clearfix">
              <div class="good-box fl">
                <div class="good-list" v-for="(j, i) in item.orderItemVoList" :key="i">
                  <div class="good-img">
                    <img v-lazy="j.productImage" alt="">
                  </div>
                  <div class="good-name">
                    <div class="p-name">{{ j.productName }}</div>
                    <div class="p-money">{{ j.totalPrice + ' X ' + j.quantity}}</div>
                  </div>
                </div>
              </div>
