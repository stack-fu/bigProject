        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div class="addr-info" :class="{'checked':i == checkIndex}" @click="checkIndex=i" v-for="(item, i) in list" :key="i">
          ...
          <div class="btn-group">
            <a href="/mimall#/cart" class="btn btn-default btn-large">返回购物车</a>
        ...
        <div class="edit-wrap">
          ...
          <div class="item">
            <select name="province" v-model="checkedItem.receiverProvince">
              <option selected disabled value="">--请选择省--</option>
              <option value="北京">北京</option>
              <option value="天津">天津</option>
              <option value="河北">河北</option>
            </select>
            <select name="city" v-model="checkedItem.receiverCity">
              <option selected disabled value="">--请选择市--</option>
              <option value="北京">北京</option>
              <option value="天津">天津</option>
              <option value="石家庄">石家庄</option>
            </select>
            <select name="district" v-model="checkedItem.receiverDistrict">
              <option selected disabled value="">--请选择区--</option>
...
export default {
  ...
  data(){
    return {
      list:[],//address
      cartList:[],//need pay list
      cartTotalPrice:0,//need to pay price
      count:0,//buy quantity
      checkedItem:{},//address
  ...
  methods: {
    ...
    getCartList() {
      this.axios.get('/carts').then((res) => {
        let list = res.cartProductVoList;//all  pro list
        this.cartTotalPrice = res.cartTotalPrice;// pro need pay
